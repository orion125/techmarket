...
public class TM_CU_Composant extends javax.swing.JFrame {
    ...
    public void initGen(TM_Composant composant){
        //test
        TM_ComposantType clavier = new TM_ComposantType(1,"clavier");
        ArrayList test0 = new ArrayList(); test0.add(clavier);
        String[] test1 = {"1.5'","2.5'","3.5'"};
 
        TM_Specification spec1test = new TM_Specification(1,"pouce", test0);
        for (int i=0;i<test1.length;i++)
            spec1test.addValpos(new TM_SpecificationAsValue(spec1test, test1[i]));
        listSpec.add(spec1test);
        
        String[] test4 = {"31'","40'","45+'"};
        spec1test = new TM_Specification(2,"taille écran", test0 );
        for (int i=0;i<test1.length;i++)
            spec1test.addValpos(new TM_SpecificationAsValue(spec1test, test4[i]));
        listSpec.add(spec1test);
        this.pack();
        this.validate();
        loadlistSpec();
