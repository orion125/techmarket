...
public class TM_ClientSelect extends javax.swing.JFrame {
    ...
    public void filterList (TM_Client cliChercher){
        ...
        if (id > -1){
                // initialisation de la position dans l'arraylist des client ici aprÃ¨s
    ...
    private void initComponents() {
        ...
        setTitle("SÃ©lection du Client Ã  ratacher Ã  la commande");

        jbtValider.setText("Valider");
        jbtValider.setToolTipText("Valider le choix du client concernÃ© par la commande");
