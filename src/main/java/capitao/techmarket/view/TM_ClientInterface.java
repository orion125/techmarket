...
public class TM_ClientInterface extends javax.swing.JFrame {
    ...
    // Met Ã  jour le GUI et appel l'initialisation des listes & arraylist
    ...
    private void loadCompo(){
        ...
        for (TM_Composant c : allComp){
            ...
            // Appel la vérification de composant par rapport au critÃ¨re
    ...
    // Vérifie si un composant correspond Ã  une liste de critÃ¨res
    ...
    private void initComponents() {
        ...
        lb_Spec.setText("SpÃ©cifications");
        ...
        men_help_apropos.setText("Ã€ propos");
    ...
    // Ajoute un composant dans la panier si il n'y est pas déjÃ 
